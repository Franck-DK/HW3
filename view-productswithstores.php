    ...
    <div class="card-body">
      ...
      <p class="card-text">
        <ul class="list-group">
          ...
          ?>
            <li class="list-group-item"><Store Name: <?php echo $store['store_name']; ?> - Date: <?php echo $store['date']; ?> Quantity: <?php echo $store['quantity']; ?>  <?php include "view-productswithstores-editform.php"; ?>
